                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                <img alt="" src="http://<?php echo $product['cover'] ?>?imageView2/2/w/200/h/200/q/75|imageslim" />
                                </div>
                            </div>
            ...
            <li>
                <div class="row">
                    ...
                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro->productid]) ?>" class="thumb-holder">
                            <img alt="<?php echo $pro->title ?>" src="http://<?php echo $pro->cover ?>?imageView2/2/w/200/h/200/q/75|imageslim" data-echo="http://<?php echo $pro->cover ?>?imageView2/2/w/200/h/200/q/75|imageslim" />
                        </a>
                    </div>
                </div>
            </li>
...
<!-- ============================================================= LINKS FOOTER : END ============================================================= -->            </div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                &copy; <a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">furongxin.cn</a> - all rights reserved
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
